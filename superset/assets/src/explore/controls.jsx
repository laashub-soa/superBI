...
import {LOCAL_PREFIX} from "@superset-ui/time-format"
...
const echartsExtendControls = {
  ...
  smooth: {
    ...
    renderTrigger: true,
    label: t("Smooth"),
    description: t("more details see https://www.echartsjs.com/zh/option.html#series-line.smooth")
  },
  ...
  axis_type: {
    ...
    description: t("More details see https://www.echartsjs.com/zh/option.html#xAxis.type")
  },
  ...
  y_axis_type: {
    ...
    description: t("More details see https://www.echartsjs.com/zh/option.html#yAxis.type")
  },
  ...
  x_axis_label_color: {
    ...
    label: t("X Axis Label Color"),
    description: t("See  https://www.echartsjs.com/zh/option.html#xAxis.axisLabel.color")
  },
  y_axis_label_color: {
    type: "ColorPickerControl",
    renderTrigger: true,
    default: {r: 0, g: 0, b: 0, a: 1},
    label: t("Y Axis Label Color"),
    description: t("See  https://www.echartsjs.com/zh/option.html#yAxis.axisLabel.color")
  },
  show_x_axis_line: {
    type: "CheckboxControl",
    renderTrigger: true,
    default: true,
    label: t("Show X Axis Line"),
    description: t("See  https://www.echartsjs.com/zh/option.html#xAxis.axisLine")
  },
  show_y_axis_line: {
    type: "CheckboxControl",
    renderTrigger: true,
    default: true,
    label: t("Show Y Axis Line"),
    description: t("See  https://www.echartsjs.com/zh/option.html#xAxis.axisLine")
  },
  label_value_rotate: {
    type: "SelectControl",
    ...
    description: t("See  https://www.echartsjs.com/zh/option.html#yAxis.axisLabel.rotate"),
    freeForm: true,
    choices: [
      [0, "0"],
      [45, "45"],
  ...
  show_area_style: {
    ...
    renderTrigger: true,
    default: true,
    label: t("Show AreaStyle"),
    description: t("See  https://www.echartsjs.com/zh/option.html#series-line.areaStyle")
  },
  start_point: {
    type: 'SpatialControl',
  ...
  globe_distance: {
    ...
    freeForm: true,
    description: t('See https://www.echartsjs.com/zh/option-gl.html#globe.viewControl.distance')
  },
  font_size: {
    type: "TextControl",
    label: t("Font Size"),
...
export const controls = {
  ...
  ...echartsExtendControls,
  auto_refresh_interval: {
    renderTrigger: true,
    freeForm: true,
    type: "SelectControl",
    label: t('Auto Refresh Interval/(s)'),
    default: 0,
    choices: [
      [0, 'None'],
      [5, '5'],
    ...
    description: t("The Inerval Of Chart Refresh Self")
  },
  datasource: {
  ...
  sql: {
    type: 'TextAreaControl',
    label: t('SQL'),
    description: t('Put your sql code here,use this function with caution'),
    aboveEditorSection: (
      <div>
...
odometer_theme: {
  ...
  scatterGLTitle: {
    type: 'TextControl',
    label: t('Title'),
    description: t('Description text that shows up top your Scatter GL'),
  },
  ...
  sacttergl_dot_color: {
    ...
    description: t('The color for points in RGB'),
  },
  ...
  sacttergl_bg_color: {
    ...
    description: t('The color for background in RGB'),
  },
  ...
  sacttergl_map_mode: {
    ...
    description: t('Select the map for scatter'),
  },
